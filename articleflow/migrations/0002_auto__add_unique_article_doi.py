...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Article', fields ['doi']
        db.create_unique('articleflow_article', ['doi'])


    def backwards(self, orm):
        # Removing unique constraint on 'Article', fields ['doi']
        db.delete_unique('articleflow_article', ['doi'])
