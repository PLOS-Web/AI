...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WatchState'
        db.create_table('articleflow_watchstate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('watcher', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, unique=True, null=True, blank=True)),
            ('last_mtime', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('articleflow', ['WatchState'])


    def backwards(self, orm):
        # Deleting model 'WatchState'
        db.delete_table('articleflow_watchstate')
