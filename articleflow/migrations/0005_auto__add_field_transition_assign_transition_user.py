...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transition.assign_transition_user'
        db.add_column('articleflow_transition', 'assign_transition_user',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transition.assign_transition_user'
        db.delete_column('articleflow_transition', 'assign_transition_user')
