...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('articleflow_article_related_articles', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_article', models.ForeignKey(orm['articleflow.article'], null=False)),
            ('to_article', models.ForeignKey(orm['articleflow.article'], null=False))
        ))
        db.create_unique('articleflow_article_related_articles', ['from_article_id', 'to_article_id'])


    def backwards(self, orm):
        # Removing M2M table for field related_articles on 'Article'
        db.delete_table('articleflow_article_related_articles')
    ...
    models = {
        'articleflow.article': {
            ...
            'article_type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'articles_typed'", 'null': 'True', 'blank': 'True', 'to': "orm['articleflow.ArticleType']"}),
            ...
            'journal': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['articleflow.Journal']", 'null': 'True', 'blank': 'True'}),
            ...
            'related_articles': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'related_by_articles'", 'blank': 'True', 'to': "orm['articleflow.Article']"}),
        ...
        'articleflow.externalsync': {
            'Meta': {'ordering': "['created']", 'object_name': 'ExternalSync'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        'articleflow.synchistory': {
            'Meta': {'ordering': "['created']", 'object_name': 'SyncHistory'},
            'completion_time': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'max_external_timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'sync': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'histories'", 'to': "orm['articleflow.ExternalSync']"})
        },
        'articleflow.transition': {
            ...
            'autoassign_new_assignee': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'new_assignee_notification': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'transitions'", 'null': 'True', 'blank': 'True', 'to': "orm['notification.NoticeType']"}),
        ...
        'articleflow.watchstate': {
            'Meta': {'object_name': 'WatchState'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'last_mtime': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'watcher': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        'auth.group': {
