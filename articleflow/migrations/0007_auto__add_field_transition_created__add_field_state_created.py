...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transition.created'
        db.add_column('articleflow_transition', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 2, 0, 0)),
                      keep_default=False)

        # Adding field 'State.created'
        db.add_column('articleflow_state', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 2, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transition.created'
        db.delete_column('articleflow_transition', 'created')

        # Deleting field 'State.created'
        db.delete_column('articleflow_state', 'created')
    ...
    models = {
        'articleflow.article': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 2, 0, 0)'}),
