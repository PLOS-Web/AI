...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleExtras.num_issues_legacy'
        db.add_column('articleflow_articleextras', 'num_issues_legacy',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleExtras.num_issues_legacy'
        db.delete_column('articleflow_articleextras', 'num_issues_legacy')
