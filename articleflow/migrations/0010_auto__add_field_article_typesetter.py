...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.typesetter'
        db.add_column('articleflow_article', 'typesetter',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='articles_typeset', null=True, blank=True, to=orm['articleflow.Typesetter']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.typesetter'
        db.delete_column('articleflow_article', 'typesetter_id')
