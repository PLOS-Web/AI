...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.current_state'
        db.add_column('articleflow_article', 'current_state',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='current_articles', null=True, blank=True, to=orm['articleflow.State']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.current_state'
        db.delete_column('articleflow_article', 'current_state_id')
