...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Journal.em_url_name'
        db.add_column('articleflow_journal', 'em_url_name',
                      self.gf('django.db.models.fields.CharField')(default='placeholder_url', max_length=200),
                      keep_default=False)

        # Adding field 'Journal.created'
        db.add_column('articleflow_journal', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 27, 0, 0)),
                      keep_default=False)

        # Adding field 'Article.em_pk'
        db.add_column('articleflow_article', 'em_pk',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.em_ms_number'
        db.add_column('articleflow_article', 'em_ms_number',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.em_max_revision'
        db.add_column('articleflow_article', 'em_max_revision',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Journal.em_url_name'
        db.delete_column('articleflow_journal', 'em_url_name')

        # Deleting field 'Journal.created'
        db.delete_column('articleflow_journal', 'created')

        # Deleting field 'Article.em_pk'
        db.delete_column('articleflow_article', 'em_pk')

        # Deleting field 'Article.em_ms_number'
        db.delete_column('articleflow_article', 'em_ms_number')

        # Deleting field 'Article.em_max_revision'
        db.delete_column('articleflow_article', 'em_max_revision')
    ...
    models = {
        'articleflow.article': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 27, 0, 0)'}),
        ...
        'articleflow.journal': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 27, 0, 0)'}),
            'em_name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'em_url_name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
