...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'State.reassign_previous'
        db.add_column('articleflow_state', 'reassign_previous',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'State.reassign_previous'
        db.delete_column('articleflow_state', 'reassign_previous')
    ...
    models = {
        'articleflow.article': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 8, 0, 0)'}),
