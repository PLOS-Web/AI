...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.article_extras'
        db.add_column('articleflow_article', 'article_extras',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='article_dont_use', null=True, blank=True, to=orm['articleflow.ArticleExtras']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.article_extras'
        db.delete_column('articleflow_article', 'article_extras_id')
