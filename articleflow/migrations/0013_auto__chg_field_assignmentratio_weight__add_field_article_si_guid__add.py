...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AssignmentRatio.weight'
        db.alter_column('articleflow_assignmentratio', 'weight', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Adding field 'Article.si_guid'
        db.add_column('articleflow_article', 'si_guid',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.md5'
        db.add_column('articleflow_article', 'md5',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=500, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Article.pubdate'
        db.alter_column('articleflow_article', 'pubdate', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'AssignmentRatio.weight'
        raise RuntimeError("Cannot reverse this migration. 'AssignmentRatio.weight' and its values cannot be restored.")
        # Deleting field 'Article.si_guid'
        db.delete_column('articleflow_article', 'si_guid')

        # Deleting field 'Article.md5'
        db.delete_column('articleflow_article', 'md5')


        # Changing field 'Article.pubdate'
        db.alter_column('articleflow_article', 'pubdate', self.gf('django.db.models.fields.DateField')(default='1900-01-01'))
