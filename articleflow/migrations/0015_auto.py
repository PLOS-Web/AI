...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field typesetters on 'State'
        db.create_table('articleflow_state_typesetters', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('state', models.ForeignKey(orm['articleflow.state'], null=False)),
            ('typesetter', models.ForeignKey(orm['articleflow.typesetter'], null=False))
        ))
        db.create_unique('articleflow_state_typesetters', ['state_id', 'typesetter_id'])


    def backwards(self, orm):
        # Removing M2M table for field typesetters on 'State'
        db.delete_table('articleflow_state_typesetters')
