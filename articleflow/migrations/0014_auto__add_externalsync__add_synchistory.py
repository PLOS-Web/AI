...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExternalSync'
        db.create_table('articleflow_externalsync', (
        ...
        db.send_create_signal('articleflow', ['ExternalSync'])

        # Adding model 'SyncHistory'
        db.create_table('articleflow_synchistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sync', self.gf('django.db.models.fields.related.ForeignKey')(related_name='histories', to=orm['articleflow.ExternalSync'])),
            ('completion_time', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('max_external_timestamp', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('articleflow', ['SyncHistory'])


    def backwards(self, orm):
        # Deleting model 'ExternalSync'
        db.delete_table('articleflow_externalsync')

        # Deleting model 'SyncHistory'
        db.delete_table('articleflow_synchistory')
