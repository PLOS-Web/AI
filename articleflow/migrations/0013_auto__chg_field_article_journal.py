...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('articleflow_article', 'journal_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articleflow.Journal'], null=True))

    def backwards(self, orm):

        # Changing field 'Article.journal'
        db.alter_column('articleflow_article', 'journal_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['articleflow.Journal']))
