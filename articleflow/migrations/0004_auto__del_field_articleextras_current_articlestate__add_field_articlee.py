...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArticleExtras.current_articlestate'
        db.delete_column('articleflow_articleextras', 'current_articlestate_id')

        # Adding field 'ArticleExtras.article'
        db.add_column('articleflow_articleextras', 'article',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='article_extras', to=orm['articleflow.Article']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ArticleExtras.current_articlestate'
        db.add_column('articleflow_articleextras', 'current_articlestate',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='article_extras', to=orm['articleflow.Article']),
                      keep_default=False)

        # Deleting field 'ArticleExtras.article'
        db.delete_column('articleflow_articleextras', 'article_id')
    ...
    models = {
        ...
        'articleflow.articleextras': {
            ...
            'article': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'article_extras'", 'to': "orm['articleflow.Article']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
