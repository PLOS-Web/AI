...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transition.autoassign_new_assignee'
        db.add_column('articleflow_transition', 'autoassign_new_assignee',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transition.autoassign_new_assignee'
        db.delete_column('articleflow_transition', 'autoassign_new_assignee')
