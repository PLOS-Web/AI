...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Typesetter'
        db.create_table('articleflow_typesetter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.CharField')(default=None, max_length=2048, null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('articleflow', ['Typesetter'])


    def backwards(self, orm):
        # Deleting model 'Typesetter'
        db.delete_table('articleflow_typesetter')
