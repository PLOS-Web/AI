...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.pdf_page_count'
        db.add_column('articleflow_article', 'pdf_page_count',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.pdf_page_count'
        db.delete_column('articleflow_article', 'pdf_page_count')
    ...
    models = {
        'articleflow.article': {
            ...
            'pdf_page_count': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
