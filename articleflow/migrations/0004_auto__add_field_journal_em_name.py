...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('articleflow_journal', 'em_name',
                      self.gf('django.db.models.fields.CharField')(default='em_name', max_length=200),
                      keep_default=False)
    ...
    models = {
        'articleflow.article': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 11, 0, 0)'}),
