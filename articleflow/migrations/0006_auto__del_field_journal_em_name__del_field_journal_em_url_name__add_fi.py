...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Journal.em_name'
        db.delete_column('articleflow_journal', 'em_name')

        # Deleting field 'Journal.em_url_name'
        db.delete_column('articleflow_journal', 'em_url_name')

        # Adding field 'Journal.em_db_name'
        db.add_column('articleflow_journal', 'em_db_name',
                      self.gf('django.db.models.fields.CharField')(default='placeholder', max_length=200),
                      keep_default=False)

        # Adding field 'Journal.em_url_prefix'
        db.add_column('articleflow_journal', 'em_url_prefix',
                      self.gf('django.db.models.fields.CharField')(default='placeholder', max_length=200),
                      keep_default=False)

        # Adding field 'Journal.em_ambra_stage_prefix'
        db.add_column('articleflow_journal', 'em_ambra_stage_prefix',
                      self.gf('django.db.models.fields.CharField')(default='placeholder', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Journal.em_name'
        db.add_column('articleflow_journal', 'em_name',
                      self.gf('django.db.models.fields.CharField')(default='placeholder', max_length=200),
                      keep_default=False)
        ...
        # Deleting field 'Journal.em_db_name'
        db.delete_column('articleflow_journal', 'em_db_name')

        # Deleting field 'Journal.em_url_prefix'
        db.delete_column('articleflow_journal', 'em_url_prefix')

        # Deleting field 'Journal.em_ambra_stage_prefix'
        db.delete_column('articleflow_journal', 'em_ambra_stage_prefix')
    ...
    models = {
        'articleflow.article': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 28, 0, 0)'}),
