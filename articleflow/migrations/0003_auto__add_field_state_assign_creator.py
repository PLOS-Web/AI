...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'State.assign_creator'
        db.add_column('articleflow_state', 'assign_creator',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'State.assign_creator'
        db.delete_column('articleflow_state', 'assign_creator')
    ...
    models = {
        'articleflow.article': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 11, 0, 0)'}),
        ...
        'articleflow.state': {
            ...
            'assign_creator': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
