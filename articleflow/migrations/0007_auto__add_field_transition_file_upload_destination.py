...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transition.file_upload_destination'
        db.add_column('articleflow_transition', 'file_upload_destination',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=600, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transition.file_upload_destination'
        db.delete_column('articleflow_transition', 'file_upload_destination')
