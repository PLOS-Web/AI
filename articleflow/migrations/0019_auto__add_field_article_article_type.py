...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('articleflow_article', 'article_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='articles', null=True, blank=True, to=orm['articleflow.ArticleType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.article_type'
        db.delete_column('articleflow_article', 'article_type_id')
    ...
    models = {
        'articleflow.article': {
            ...
            'article_type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'articles'", 'null': 'True', 'blank': 'True', 'to': "orm['articleflow.ArticleType']"}),
