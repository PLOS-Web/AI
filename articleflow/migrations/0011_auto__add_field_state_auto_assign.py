...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'State.auto_assign'
        db.add_column('articleflow_state', 'auto_assign',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'State.auto_assign'
        db.delete_column('articleflow_state', 'auto_assign')
