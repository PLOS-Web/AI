...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'State.progress_index'
        db.add_column('articleflow_state', 'progress_index',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'State.progress_index'
        db.delete_column('articleflow_state', 'progress_index')
    ...
    models = {
        'articleflow.article': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 0, 0)'}),
