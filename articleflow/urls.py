...
urlpatterns = patterns('articleflow.views',
                       ...
                       url(r'^detail/(?P<doi>[a-z|\.|0-9]{0,50})/transitions/upload$', ArticleDetailTransitionUpload.as_view(), name='detail_transition_upload'),
                       url(r'^detail/(?P<doi>[a-z|\.|0-9]{0,50})/lala', ArticleDetailTransitionPanel.as_view(), name='transitions_panel'),
                       ...
                       url(r'^detail/(?P<doi>[a-z|\.|0-9]{0,50})/assign-article', AssignArticle.as_view(), name='assign_article'),
                       ...
                       url(r'^detail/(?P<doi>[a-z|\.|0-9]{0,50})/corrections_file/$', HandleCorrectionsDoc.as_view(), name='corrections_file'),
