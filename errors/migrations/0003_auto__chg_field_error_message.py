...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Error.message'
        db.alter_column('errors_error', 'message', self.gf('django.db.models.fields.CharField')(max_length=4096))

    def backwards(self, orm):

        # Changing field 'Error.message'
        db.alter_column('errors_error', 'message', self.gf('django.db.models.fields.CharField')(max_length=600))
    ...
    models = {
        ...
        'errors.error': {
            ...
            'message': ('django.db.models.fields.CharField', [], {'max_length': '4096'}),
