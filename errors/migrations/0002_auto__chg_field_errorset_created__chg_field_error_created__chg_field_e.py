...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('errors_errorset', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Error.created'
        db.alter_column('errors_error', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ErrorStatus.created'
        db.alter_column('errors_errorstatus', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))
