...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.user_selectable'
        db.add_column('issues_category', 'user_selectable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.user_selectable'
        db.delete_column('issues_category', 'user_selectable')
    ...
    models = {
        'articleflow.article': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 12, 0, 0)'}),
