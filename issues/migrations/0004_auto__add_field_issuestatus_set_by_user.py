...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IssueStatus.set_by_user'
        db.add_column('issues_issuestatus', 'set_by_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='statuses_set', null=True, blank=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IssueStatus.set_by_user'
        db.delete_column('issues_issuestatus', 'set_by_user_id')
    ...
    models = {
        ...
        'issues.issuestatus': {
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'set_by_user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'statuses_set'", 'null': 'True', 'blank': 'True', 'to': "orm['auth.User']"}),
